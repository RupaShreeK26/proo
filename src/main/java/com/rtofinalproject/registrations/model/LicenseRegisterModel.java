...
public class LicenseRegisterModel {
	...
	public String toString() {
		return "LicenseRegisterModel [license_id=" + license_id + ", fullName=" + fullName + ", age=" + age
				+ ", aadharNumber=" + aadharNumber + ", mobileNumber=" + mobileNumber + ", state=" + state
				+ ", address=" + address + ", dateOfIssue=" + dateOfIssue + ", typeOfVehicle=" + typeOfVehicle
	...
	public void generateLicenseNumber() {
        ...
        String randomString = generateRandomString(6); // Generate a random alphanumeric string
